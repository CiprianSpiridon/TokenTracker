...
// TASK-011: inlined here to avoid pulling the ~4000-line rollout module on
// every `tokentracker status` / `diagnostics` invocation. rollout.js still
// exports resolveKiroCliDbPath for external callers.
